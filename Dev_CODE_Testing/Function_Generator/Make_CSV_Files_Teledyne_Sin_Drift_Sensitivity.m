...
Parameter.Name                      = 'Sine10Hz_Drift_AmpChange';
...
%Sin 10Hz 
Signal_sin.f        = 10;
Signal_sin.Ampmod_f = 0.02;
Signal_sin.timevec  = (0:1:(Parameter.Function_generator_samples-1))/Parameter.Function_generator_fs;
Signal_sin.timevec2 = mod(Signal_sin.timevec*Signal_sin.Ampmod_f,1).^4;

Signal_sin.signal   = Parameter.Signal_Amp * sin(Signal_sin.f *Signal_sin.timevec*2*pi).*Signal_sin.timevec2 ;
